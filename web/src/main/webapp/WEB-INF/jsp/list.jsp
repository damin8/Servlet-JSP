...
<div class="header header-trans">
    <div class="container">
        ...
        <div id="nav-menu">
            ...
            <span id="select" onclick="goToLink('list')">목록</span>
...
<div class="article">
    <div class="article-wrapper">
        <div class="container">
            <div class="content">
                <div class="content-header">전체 목록</div>
                <div class="table">
...
<%--                            </c:if>--%>
                            ...
                            <c:if test="${startNum + 4 < lastNum}">
                                <li class="page-item"><a class="page-link" href="?p=${startNum + 5}&option=${param.option}&searchContent=${param.searchContent}">다음</a></li>
                            </c:if>
